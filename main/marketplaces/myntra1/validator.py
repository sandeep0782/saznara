from main.marketplaces.myntra1.mappings import get_myntra_blouse, get_myntra_blouse_fabric, get_myntra_border, get_myntra_color, get_myntra_occasion, get_myntra_ornamentation, get_myntra_pattern, get_myntra_print_or_pattern_type, get_myntra_saree_fabric, get_myntra_technique
