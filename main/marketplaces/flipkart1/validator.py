...
from main.marketplaces.flipkart1.mappings import get_flipkart_blouse, get_flipkart_blouse_fabric, get_flipkart_border, get_flipkart_color, get_flipkart_occasion, get_flipkart_ornamentation, get_flipkart_pattern, get_flipkart_print_or_pattern_type, get_flipkart_saree_fabric, get_flipkart_technique 
