from main.marketplaces.snapdeal.mappings import (
    ...
    get_snapdeal_blouse_fabric,
    get_snapdeal_blouse_pattern,
    get_snapdeal_border,
    get_snapdeal_color,
    get_snapdeal_ornamentation,
    get_snapdeal_pattern,
    get_snapdeal_print_or_pattern_type,
    get_snapdeal_saree_fabric,
    get_snapdeal_technique,
)
...
def validate_snapdeal_colors(sku_list):
    ...
    for sku in sku_list:
        ...
        if not mapped_color:
            invalid_colors.append(f"{original_color} - Missing mapping")
            continue
...
def validate_snapdeal_blouse_colors(sku_list):
    ...
    for sku in sku_list:
        ...
        if not mapped_color:
            invalid_blouse_colors.append(f"{original_blouse_color} - Missing mapping")
            continue
...
def validate_snapdeal_technique(sku_list):
    ...
    for sku in sku_list:
        ...
        if not mapped_technique:
            invalid_technique.append(f"{original_type} - Missing mapping")
            continue
...
def validate_snapdeal_saree_fabric(sku_list):
    ...
    for sku in sku_list:
        ...
        mapped_saree_fabric = get_snapdeal_saree_fabric(original_saree_fabric)

        if not mapped_saree_fabric:
            invalid_saree_fabric.append(f"{original_saree_fabric} - Missing mapping")
            continue
...
def validate_snapdeal_blouse_fabric(sku_list):
    ...
    for sku in sku_list:
        ...
        mapped_blouse_fabric = get_snapdeal_blouse_fabric(original_blouse_fabric)

        if not mapped_blouse_fabric:
            invalid_blouse_fabric.append(f"{original_blouse_fabric} - Missing mapping")
            continue
...
def validate_snapdeal_blouse(sku_list):
    ...
    for sku in sku_list:
        ...
        if not mapped_blouse:
            invalid_blouse.append(f"{original_blouse} - Missing mapping")
            continue
...
def validate_snapdeal_pattern(sku_list):
    ...
    for sku in sku_list:
        ...
        if not mapped_pattern:
            invalid_pattern.append(f"{original_pattern} - Missing mapping")
            continue
...
def validate_snapdeal_ornamentation(sku_list):
    ...
    for sku in sku_list:
        ...
        mapped_ornamentation = get_snapdeal_ornamentation(original_ornamentation)

        if not mapped_ornamentation:
            invalid_ornamentation.append(f"{original_ornamentation} - Missing mapping")
            continue
...
def validate_snapdeal_border(sku_list):
    ...
    for sku in sku_list:
        ...
        if not mapped_border:
            invalid_border.append(f"{original_border} - Missing mapping")
            continue
...
def validate_snapdeal_template(sku_list):
    ...
    print_or_pattern_type_errors = validate_snapdeal_print_or_pattern_type(sku_list)
